...
using RapidPay.Identity.Pages.Consent;
using InputModel = RapidPay.Identity.Pages.Device.InputModel;
using ScopeViewModel = RapidPay.Identity.Pages.Device.ScopeViewModel;
using ViewModel = RapidPay.Identity.Pages.Device.ViewModel;
